...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { address: @university.address, email: @university.email, firstname: @university.firstname, fullname: @university.fullname, lastname: @university.lastname, phone: @university.phone, subject: @university.subject }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { address: @university.address, email: @university.email, firstname: @university.firstname, fullname: @university.fullname, lastname: @university.lastname, phone: @university.phone, subject: @university.subject }
    assert_redirected_to university_path(assigns(:university))
  end
